            ...
            modelBuilder.Entity("WalletApp.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b30c5ec9-2a7c-4fdb-bb95-f8b8a3ad56de"),
                            IsDeleted = false,
                            Name = "Rachunki"
                        });
                });
            ...
            modelBuilder.Entity("WalletApp.Domain.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("04d23244-906e-46bb-8f49-b41f9c91843e"),
                            Ask = 4.055m,
                            Bid = 3.972m,
                            Code = "USD",
                            CurrencyName = "dolar amerykanski",
                            IsDeleted = false,
                            TradingDate = new DateTime(2023, 11, 19, 17, 28, 38, 654, DateTimeKind.Local).AddTicks(4428)
                        },
                        new
                        {
                            Id = new Guid("12d7f549-f196-41d8-bfc0-dc5de47a810c"),
                            Ask = 4.055m,
                            Bid = 3.972m,
                            Code = "EUR",
                            CurrencyName = "euro",
                            IsDeleted = false,
                            TradingDate = new DateTime(2023, 11, 19, 17, 28, 38, 654, DateTimeKind.Local).AddTicks(4472)
                        },
                        new
                        {
                            Id = new Guid("b127be30-2713-4bad-a2a4-8d257ceeed62"),
                            Ask = 4.055m,
                            Bid = 3.972m,
                            Code = "CHF",
                            CurrencyName = "frank szwajcarski",
                            IsDeleted = false,
                            TradingDate = new DateTime(2023, 11, 19, 17, 28, 38, 654, DateTimeKind.Local).AddTicks(4475)
                        },
                        new
                        {
                            Id = new Guid("0c0fb5a4-6e0c-4c31-a599-fb7dd41ae0a6"),
                            Ask = 4.055m,
                            Bid = 3.972m,
                            Code = "GBP",
                            CurrencyName = "funt szterling",
                            IsDeleted = false,
                            TradingDate = new DateTime(2023, 11, 19, 17, 28, 38, 654, DateTimeKind.Local).AddTicks(4478)
                        });
                });
